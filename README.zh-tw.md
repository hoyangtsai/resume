...
- 主導 Creator Motion Tokens 主題系統的重大擴充——新增可跨類型連結的漸層 token，以及位置、縮放、旋轉、傾斜等變形/樣式 token——單次改動涵蓋 166 個檔案，橫跨 token 建立、連結與主題管理介面
...
- 強化多動畫 dotLottie 匯入/匯出的穩定性，修復 slot ID 衝突、狀態機遺失、匯出不完整等問題，9 個月內共合併 40 多個 PR
